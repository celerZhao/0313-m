...
export function nativeShare(shareBtnId, pcode, config) {
    ...
    this.html = function() {
        var contHtml = '<div class="cont-share clear cont word-break">'+
            ...
            '<span data-app="weixinFriend" class="iconcell weixin_friend" id="weixin_friend"><i class="iocnshare"></i>微信朋友圈</span>'+
            '<span data-app="copylink" class="iconcell copylink" id="copybtn"><i class="iocnshare"></i>复制链接</span>'+
            '<div id="copylink" style="display:none;background-color:#fff;">'+
                '<p>请手动复制此链接</p>'+
